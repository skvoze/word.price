      ...
      <Card className="p-6 space-y-6 text-sm leading-relaxed border-white/5 bg-zinc-900/50 text-zinc-300 rounded-[2rem]">
        ...
        <section>
          ...
          <p>
            ...
            <br />
            3.2. <b>Возврат предоплаты:</b> при успешном выполнении условий задачи сумма возвращается в полном объеме как компенсация за достигнутый результат. 
            <br />
        ...
        <section>
          ...
          <p>
            ...
            <br />
            4.3. В случае отклонения отчета Пользователь вправе дополнить его в течение 48 часов или подать апелляцию на email. Срок рассмотрения — 3 рабочих дня. Решение Исполнителя по апелляции является окончательным.
          </p>
        </section>
