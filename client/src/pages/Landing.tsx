  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 font-sans selection:bg-white selection:text-black">
      <main className="max-w-4xl mx-auto px-4 py-20">
        ...
        {/* ——— 4. MAIN CALL TO ACTION С КАСТОМНЫМ ВЫБОРОМ СЕТИ ——— */}
        <section className="flex flex-col items-center mb-48">
                      ...
                      if (!connected) {
                        return (
                          <button
                            ...
                            type="button"
                            className="bg-white text-black font-black uppercase italic tracking-tight text-sm px-8 py-4 rounded-full hover:bg-zinc-200 transition-colors shadow-lg"
                          >
                            Enter the Protocol
                          </button>
                        );
                      ...
                      return (
                        <div className="flex flex-col sm:flex-row items-center gap-3 bg-zinc-900 border border-zinc-800 p-2 rounded-full">
                          <button
                            ...
                            type="button"
                            className="bg-zinc-800 text-white text-xs font-bold uppercase tracking-wider px-4 py-2 rounded-full hover:bg-zinc-700 transition-colors flex items-center gap-2"
                          >
                            {chain.hasIcon && (
                              <div
                                style={{
                          ...
                          <div className="text-zinc-400 text-xs font-mono px-4 py-2">
                            {account.displayName}
                          </div>
                        </div>
                      );
          ...
          <div className="flex items-center gap-6 text-zinc-500">
            <div className="flex items-center gap-2 text-[9px] font-black uppercase tracking-widest">
              <Globe className="w-3 h-3" /> Multi-Chain Support
            </div>
          ...
          <div className="bg-zinc-900/30 border border-zinc-800 rounded-[3rem] p-10 md:p-16 relative overflow-hidden">
            ...
            <div className="max-w-2xl mx-auto space-y-12">
              <div className="text-center">
                ...
                <p className="text-zinc-500 text-xs uppercase tracking-[0.2em] font-bold">Multi-Chain Protocol</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-zinc-950/50 p-6 rounded-2xl border border-zinc-800/50">
                  ...
                  <p className="text-zinc-500 text-[11px] leading-relaxed">
                    We support <b>USDC</b> for stable commitments. Your amount remains pegged to the dollar, unaffected by market volatility. No surprises when you recover your funds.
                  </p>
                </div>
              ...
              <div className="text-center pt-6">
                <p className="text-[10px] text-zinc-600 uppercase font-black tracking-[0.2em] leading-relaxed max-w-sm mx-auto">
                  Commit in USDC. Success costs nothing. <br/>
        ...
        <footer className="border-t border-zinc-900 pt-20 pb-10">
          ...
          <div className="text-[9px] text-zinc-700 uppercase tracking-[0.4em] text-center border-t border-zinc-900 pt-10 space-y-6">
            ...
            <p>© 2026 WORD PRICE. DECENTRALIZED ACCOUNTABILITY.</p>
            ...
            <div className="flex justify-center items-center gap-8 opacity-20 hover:opacity-100 transition-opacity duration-700 grayscale">
                <span className="font-black text-[10px]">SECURE L2</span>
